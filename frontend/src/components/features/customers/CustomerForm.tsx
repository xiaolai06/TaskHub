      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white shadow-xl">
          ...
          <div className="flex items-center justify-between border-b px-6 py-4">
            <h2 className="text-base font-semibold text-slate-800">{isEdit ? '编辑客户' : '添加客户'}</h2>
          ...
          <form onSubmit={handleSubmit} className="max-h-[70vh] overflow-y-auto px-6 py-5">
            <div className="space-y-4">
              {/* 客户名称 */}
              <div>
                <label className="mb-1.5 block text-sm font-medium text-slate-700">客户名称 <span className="text-red-500">*</span></label>
                <input
                  type="text"
                  value={name}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-slate-700">客户状态</label>
                  <select
                    value={status}
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-slate-700">所属行业</label>
                  <input
                    type="text"
                    value={industry}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-slate-700">公司</label>
                  <input
                    type="text"
                    value={company}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-slate-700">地址</label>
                  <input
                    type="text"
                    value={address}
